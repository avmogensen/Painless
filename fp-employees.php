			            ...
			            <div class="team-pop">
			                <div class="team-info">
								...
								<ul class="team-social">
									...
									<?php endif; ?>
									<?php if ($twitter != '') : ?>
										<li><a class="twitter" href="<?php echo esc_url("https://www.linkedin.com/in/caroline-brygger-loran-726a9812a/"); ?>" target="_blank"><i class="fa fa-linkedin"></i></a></li>
									<?php endif; ?>
									<?php if ($google != '') : ?>
										<li><a class="google" href="<?php echo esc_url("http://avmogensen.dk/painless/CV-2018-Mie-Bang.pdf"); ?>" target="_blank"><i class="fa fa-paperclip"></i></a></li>
									<?php endif; ?>
								</ul>
			                </div>
			            </div>
